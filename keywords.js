(() => {
  ...
  rd("RD 2 Bewusstsein - Nachforderung NA", "emergency", ["NEF"], true),
  rd("RD 1 Atmung - Atmung", "emergency", ["RTW"], true),
  rd("RD 2 Atmung - vitale Bedrohung", "emergency", ["RTW", "NEF"], true),
  rd("RD 2 Atmung - Nachforderung NA", "emergency", ["NEF"], true),
  ...
  rd("RD 2 Neuro/Psych - Psych Nachforderung NA", "emergency", ["NEF"], true),
  ...
  rd("RD 2 Trauma - Nachforderung NA", "emergency", ["NEF"], true),
  ...
  rd("RD 2-KIND Kind - Nachforderung NA", "emergency", ["NEF"], true),
  rd("RD 0 Sonstige - Hilfeleistung akut", "emergency", ["REF"], true),
  rd("RD 0 Sonstige - Hausnotruf aktiver Alarm", "emergency", ["REF"], true),
  ...
  rd("RD KTP Verlegung - nicht disponibel mit KTW (Prio 1)", "emergency", ["KTW"], true),
  rd("RD 1 Verlegung - Notfalltransport mit RTW", "emergency", ["RTW"], true),
  rd("RD 2 Verlegung - Notfalltransport mit NA", "emergency", ["RTW", "NEF"], true),
  rd("RD VEF Verlegung - VEF", "transport", ["RTW"], false),
  rd("RD VEF Verlegung - VEF und RTW", "transport", ["RTW", "NEF"], false),
  ...
  rd("RD 2 Sonstige - Nachforderung NA", "emergency", ["NEF"], true),
  ...
  rd("RD 2 Ärger - Nachforderung NA", "emergency", ["NEF"], true),
  ...
  rd("RD 5 - sechs bis neun verletzte/erkrankte Personen", "emergency", ["RTW", "RTW", "RTW", "RTW", "RTW", "RTW", "NEF", "NEF"], true),
  rd("RD MANV 10-15", "emergency", [], true),
  rd("RD MANV 16-25", "emergency", [], true),
  rd("RD MANV 26-50", "emergency", [], true),
  rd("RD MANV 51-100", "emergency", [], true),
  rd("RD MANV ab 100", "emergency", [], true),
  rd("RD ABSICHERUNG - Bereitstellung Rettungsmittel", "scheduled", ["RTW"], true),
  ...
  rd("RD BETREUUNG - Betreuung unter 50 Personen", "scheduled", [], false),
  rd("RD BETREUUNG - Betreuung über 50 Personen", "scheduled", [], false),
  ...
  rd("RD HILFE/SONSTIGE - Transport Organ/Blut/Material", "scheduled", ["KTW"], false),
  rd("RD ÜBERÖRTLICH - Anforderung Fremd-ILS Bayern", "scheduled", [], false),
  rd("RD ÜBERÖRTLICH - Anforderung Fremd-ILS nicht Bayern", "scheduled", [], false)
];
})();
